            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Attach a thought, quote, or reminder to a book.",
                      ...
                      onPressed: () async {
                        ...
                        if (ok) {
                          ...
                          messenger.showSnackBar(
                            SnackBar(
                              content: Text(_noteController.errorMessage.value),
                            ),
                          );
                        }
                      },
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  _noteController.findBookTitle(note.bookId),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AppBackground(
        child: SafeArea(
          child: Obx(() {
            if (_noteController.isLoading.value && _noteController.notes.isEmpty) {
              ...
              return Center(
                child: Padding(
                  ...
                  child: AppInlineMessage(
                    message: _noteController.errorMessage.value,
                  ),
                ),
              );
            }
            ...
            return RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    "Keep your takeaways and reading reminders close.",
                    style: TextStyle(color: mutedTextColor),
                  ),
                  const SizedBox(height: 18),
                  AppSectionCard(
                  ...
                  if (_noteController.errorMessage.value.isNotEmpty) ...[
                    const SizedBox(height: 14),
                    AppInlineMessage(message: _noteController.errorMessage.value),
                  ],
                  const SizedBox(height: 18),
                    ...
                    const AppSectionCard(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 6),
                          Text(
                            "Create your first note to keep quotes and reminders close.",
